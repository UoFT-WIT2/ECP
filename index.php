  ...
  ​ <navbar-component></navbar-component>
    ...
    <main>
      ...
      <div class="container ">
        <div class="row justify-content-center">
          ...
          <?php
              ...
              $sql = "select title, briefDescription, Description, nameOfUser, image from blogs";
      ...
      <div class="main_button">
          <a href="blogs.html"><button>Read More Blogs </button></a>
      </div> 
    </main>
    <a href="adminHomePage.html">admin home page</a><br>
